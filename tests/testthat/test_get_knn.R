...
res <- hnsw_knn(ui10, k = 1, include_self = FALSE)
expect_is(res$idx, "matrix")
expect_is(res$dist, "matrix")
expect_equal(res$idx, self_nn_index4[, 2], check.attributes = FALSE)
